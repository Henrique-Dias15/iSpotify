    ...
    <div className='Display'>
      ...
      <div className='Main'>
        ...
        <div className='Botões'>
          <img src="src\assets\botãoPlay.svg" alt="" />
          <img src="src\assets\coraçãoDefault.svg" alt="" />
          <img src="src\assets\botãoDownload.svg" alt="" />
          <img src="src\assets\3pontos.svg" alt="" />
        </div>
        ...
        <div className='Playlist'>
          ...
          <div className='Um'>
            ...
            <div className='MusicasSimbolos'>
              <img src="src\assets\coraçãoDefault.svg" alt="" />
              <img src="src\assets\lixo.svg" alt="" />
            </div>
          </div>
